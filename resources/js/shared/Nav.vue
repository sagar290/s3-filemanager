<template>
    <ul class="space-y-2 text-sm" id="navigation">
        <li>
            <a href="#"
               class="flex items-center space-x-3 text-gray-700 p-2 rounded-r-[20px] font-medium hover:bg-gray-200 bg-[#e8f0fe] focus:shadow-outline">
                <span class="text-gray-600">
                    <svg class=" c-qd" width="24px" height="24px" viewBox="0 0 24 24" fill="#5f6368" focusable="false">
                      <path
